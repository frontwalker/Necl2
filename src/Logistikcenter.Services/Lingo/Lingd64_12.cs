 ...
 **
 **    Lingd64_12.cs (LINGO Win64 DLL header for C# .NET)
 **
...
namespace Logistikcenter.Services.Lingo
{
    ...
    public class lingo
    {
        ...
        [DllImport("lingd64_12.dll", EntryPoint = "LSsetCallbackSolverLng")]
        ...
        [DllImport("lingd64_12.dll", EntryPoint = "LSsetPointerLng")]
